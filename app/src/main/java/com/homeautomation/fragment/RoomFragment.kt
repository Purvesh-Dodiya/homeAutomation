...
import kotlinx.android.synthetic.main.fragment_room.noData
import kotlinx.android.synthetic.main.fragment_room.progressBar
import kotlinx.android.synthetic.main.fragment_room.recyclerHall
...
class RoomFragment : Fragment() {
    ...
    private fun checkForData() {
        ...
        database = Firebase.database.reference.child("users").child(userID).child("SWITCH/ROOM")
